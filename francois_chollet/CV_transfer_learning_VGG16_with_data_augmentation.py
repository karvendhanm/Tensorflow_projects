...
callbacks = [keras.callbacks.ModelCheckpoint(
    filepath='./model_checkpoints/convnet_transfer_learning_data_augmentation.keras',
    monitor='val_loss',
    save_best_only=True)]
...
test_model = keras.models.load_model('./model_checkpoints/convnet_transfer_learning_data_augmentation.keras')
